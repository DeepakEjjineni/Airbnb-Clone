const sampleListings = [
  ...
  },
  {
    ...
    description:
      "Experience the romance of Paris in this charming apartment with views of the Eiffel Tower.",
    image: {
  ...
  },
  {
    ...
    description:
      "Relax in this peaceful cabin nestled in the heart of the Great Smoky Mountains.",
    image: {
  ...
  {
    title: "Stunning Santorini Villa",
    description:
      "Wake up to breathtaking sunsets in this luxury villa overlooking the Aegean Sea in Santorini.",
    image: {
